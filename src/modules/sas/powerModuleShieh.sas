...
PROC IML;
ALPHA=0.05;N=110;
B={114.46 104.66 98.83, 2.88 8.77 10.67, -0.71 -0.90 -1.30, -0.21 -0.54 -0.72};
SIGMA={218.48 83.66 72.19, 83.66 251.92 158.60, 72.19 158.60 244.58};
KSTAR={1 0 1 0,0 1 0 3,1 0 3 0,0 3 0 15};
...
NCPT1 = N#EFST1;
NCPT2 = N#EFST2;
PRINT FCRITL CA DF2L NCPL;
PRINT FCRITV CA DF2V NCPV;
PRINT FCRITT1 CA DF2T1 NCPT1;
PRINT FCRITT2 CA DF2T2 NCPT2;
QUIT;
